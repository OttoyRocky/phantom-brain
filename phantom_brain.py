...
# --- System Prompts (modulo separado) ---
from prompts.system_prompts import SYSTEM_PROMPTS, SYSTEM_PROMPT, obtener_prompt
...
def analizar(scan_input, modelo, tipo_captura="Generico"):
    ...
    try:
        ...
        client = _ollama_mod.Client(host="http://172.20.160.1:11434", timeout=timeout)
