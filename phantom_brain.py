...
2. Evalúa la frecuencia (125kHz LF o 13.56MHz HF)
...
4. Busca vulnerabilidades específicas:
   ...
   - EMV: datos básicos legibles sin autenticación, relay attack posible
   - ST25TA: lectura NFC sin autenticación en algunos casos
   - Indala: formato propietario sin cifrado en versiones antiguas
5. Recomienda comandos proxmark3 específicos para explotación
6. Sugiere herramientas complementarias según el tipo de tarjeta
...
Descripcion técnica de por qué es explotable
...
def menu_subghz():
    ...
    try:
        ...
        if opcion == 0:
            ...
            return parsear_subghz_archivo(capturas[opcion - 1])
        else:
...
def menu_nfc():
    ...
    try:
        ...
        if opcion == 0:
            ...
            return parsear_nfc_archivo(capturas[opcion - 1])
        else:
            print("Opcion invalida.")
            return None
    except ValueError:
